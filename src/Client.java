...
class Client {
    ...
    public void run() throws Exception {
        ...
        if (Main.gVerbose) {
        	System.err.println("Shots: " + Player.getShots());
    		System.err.println("Hits: " + Player.getHits());
    		System.err.println("Ratio: " + (float) Player.getHits() / (float) Player.getShots());
    		System.err.println("ROE: " + ((float) Player.getHits() / (float) Player.getShots() - 0.11111));
